...
const articles = [
  ...
  },
  {
    ...
    answer:
      "Да, срочная обработка возможна. Дополнительная стоимость за срочность обговаривается индивидуально — напиши мне, уточним детали и договоримся.",
  },
  {
...
export function InsightsSection() {
  ...
  return (
    <section className="px-6 py-24" onMouseMove={handleMouseMove}>
