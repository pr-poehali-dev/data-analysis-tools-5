          ...
          {hovered && (
            ...
            >
              ...
              <div className="relative h-full flex flex-col justify-center px-5 py-4">
                <p style={{ fontSize: 8, letterSpacing: "0.3em", textTransform: "uppercase", color: "#999999", fontFamily: "Inter, system-ui, sans-serif", marginBottom: 8 }}>
                  {tag}
                </p>
                <h3 style={{ fontFamily: "Inter, system-ui, sans-serif", fontSize: 16, lineHeight: 1.3, color: "#111111", marginBottom: 8 }}>
                  {title}
                </h3>
                <p style={{ fontFamily: "Inter, system-ui, sans-serif", fontSize: 12, lineHeight: 1.7, color: "#444444" }}>
                  {description}
                </p>
              </div>
            </motion.div>
