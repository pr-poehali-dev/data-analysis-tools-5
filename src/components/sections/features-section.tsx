...
const services = [
  {
    ...
    description: "Студийные и уличные портреты, арт-концепции, образы — каждый формат под твою идею.",
    tag: "Portrait",
  },
  {
    title: "Репортажная съёмка",
    description: "Свадьбы, крещения, выпускные и другие важные события, которые нельзя упустить.",
    tag: "Reportage",
  },
  {
    title: "Обработка",
    description: "Ретушь и цветокоррекция с вниманием к каждой детали. Готовность зависит от текущей загруженности.",
    tag: "Retouch",
  },
]
          ...
          {hovered && (
            ...
            >
              ...
              <div className="relative h-full flex flex-col justify-center px-5 py-4">
                <p style={{ fontSize: 8, letterSpacing: "0.3em", textTransform: "uppercase", color: "hsl(30 40% 35%)", fontFamily: "'IM Fell English', serif", marginBottom: 8 }}>
                  {tag}
                </p>
                <h3 style={{ fontFamily: "'IM Fell English', serif", fontSize: 16, lineHeight: 1.3, color: "hsl(25 30% 15%)", marginBottom: 8 }}>
                  {title}
                </h3>
                <p style={{ fontFamily: "'IM Fell English', serif", fontSize: 12, lineHeight: 1.7, color: "hsl(25 20% 30%)" }}>
                  {description}
                </p>
              </div>
            </motion.div>
