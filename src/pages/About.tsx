            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center mb-32">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Я всегда чувствовала, что вокруг нас происходит что-то удивительное — в случайном взгляде, в игре света, в живых эмоциях людей. Фотография стала для меня способом останавливать эти моменты и сохранять их навсегда.
                </p>
